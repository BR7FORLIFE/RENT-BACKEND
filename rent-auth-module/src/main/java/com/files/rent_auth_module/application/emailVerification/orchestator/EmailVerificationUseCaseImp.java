                                ...
                                .flatMap(tuple -> {
                                        ...
                                        return emailVerificationPort
                                                        ...
                                                        .then(sendEmailVerificationToken(
                                                                        user.getId(),
                                                                        user.getEmail().trim()))
                                                        .thenReturn(new EmailForwardCommandResult("email reenviado!"));
                                });
        }
        ...
        public Mono<EmailVerificationCommandResult> verificationToken(EmailVerificationCommand cmd) {
                return emailVerificationPort.findByToken(cmd.token())
                                ...
                                .flatMap(tuple -> {
                                        ...
                                        return Mono.when(emailVerificationPort.save(consumed),
                                                        authRepositoryPort.save(changeEnabledUser))
                                                        .thenReturn(new EmailVerificationCommandResult(
                                                                        "Verificacion de email exitosa!"));
                                });
        }
}
