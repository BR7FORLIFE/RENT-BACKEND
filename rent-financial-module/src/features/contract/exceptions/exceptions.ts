...
export class contractDraftAvailabilityNotFoundException extends AppException {
  constructor() {
    super(
      'No hay un borrador de contrato donde ambas partes hayan aceptado los terminos!',
      404,
      'NOT_FOUND',
    );
  }
